# Porty wejścia/wyjścia VIC-20 i architektura rozszerzeń

Dokument opisuje porty fizyczne VIC-20 oraz ich mapowanie na rejestry układów I/O. Szczegółowy dokument PET/CBM znajduje się w `docs/pet/io-ports.md`.
...
- [VIC-20 IEC w tym repozytorium](disk.md) — potwierdzone połączenia linii IEC i ich rejestrów.
- [VIC-20 kaseta w tym repozytorium](tape.md) — mapowanie linii kasety i ograniczenia modelu.
