...
[TestFixture]
public sealed class MT6545Tests
{
    [Test]
    ...
    {
        var first = new MT6545("CRTC1", 0xE880);
        var second = new MT6545("CRTC2", 0xE890);
    ...
    private static void WriteRegister(MT6545 crtc, byte register, byte value)
    {
        crtc.Write(0, register);
        crtc.Write(1, value);
    }

    private static void Tick(MT6545 crtc, int count)
    {
